...
public class GetFactByStreetcodeIdHandler : IRequestHandler<GetFactByStreetcodeIdQuery, Result<IEnumerable<FactCreateDto>>>
{
    ...
    public async Task<Result<IEnumerable<FactCreateDto>>> Handle(GetFactByStreetcodeIdQuery request, CancellationToken cancellationToken)
    {
        ...
        return Result.Ok(_mapper.Map<IEnumerable<FactCreateDto>>(fact));
    }
}