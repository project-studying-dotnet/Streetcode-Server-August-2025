...
public class GetFactByIdHandler : IRequestHandler<GetFactByIdQuery, Result<FactCreateDto>>
{
    ...
    public async Task<Result<FactCreateDto>> Handle(GetFactByIdQuery request, CancellationToken cancellationToken)
    {
        ...
        return Result.Ok(_mapper.Map<FactCreateDto>(facts));
    }
}